...
const Hero = () => {
  return (
    <div className="w-full border border-indigo-600 bg-[url('/images/Hero.png')] h-[200px] sm:h-[300px] bg-[length:100%] sm:bg-cover  flex items-center  px-6 md:bg-contain md:h-[550px] md:flex md:items-center md:w-full lg:h-[730px] bg-no-repeat  lg:flex lg:items-center ">
